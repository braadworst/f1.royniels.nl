module.exports = road => {
  ...
  road
    ...
    .where('client')
      .error('templating.error.default')
    .where('webserver')
      .run('-authAndLogin', 'templating.state.set')
      .error('templating.error.internalServerError')
      .error('response.html.internalServerError')
      .notFound('templating.error.notFound')
      .notFound('response.html.notFound')
      .stop('response.html.default')
    .where('apiserver')
