    ...
    <div class="pure-g">
      ...
      <div class="pure-u-1-1 pure-u-md-2-5">
        <div class="content">
          <h2>Race</h2>
          <h4>Drivers</h4>
          <p>Every driver in your team will get points based on the real F1 point system.</p>
          <h4>Engine</h4>
          <p>The points that your teams engine will be awarded is the sum of each car that ends in the top ten that has your engine.</p>
          <h4>Chassis</h4>
          <p>Your team gets points for the chassis, it is the sum of the cars that end in the top ten.</p>
          <h4>Driver of the day</h4>
          <p>The driver of the day is selected by f1.com. Guessing the right driver will give your team&nbsp;<strong>10 points</strong>.</p>
          <h4>Fastest driver</h4>
          <p>Your team will earn&nbsp;<strong>10 points</strong>&nbsp;when predicting the fastest driver correctly.</p>
        </div>
      </div>
